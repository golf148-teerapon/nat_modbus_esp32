...
IPAddress local_IP(192, 168, 1, 21); // Static IP address192.168.100.164
...
void loop() 
{
  ...
  d200.toCharArray(d0, 16);client.publish("ARP01/D200", d0);
  d202.toCharArray(d1, 16);client.publish("ARP01/D202", d1);
  d204.toCharArray(d2, 16);client.publish("ARP01/D204", d2);
