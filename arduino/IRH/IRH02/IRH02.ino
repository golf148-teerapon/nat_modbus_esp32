...
IPAddress local_IP(192, 168, 1, 82); // Static IP address192.168.100.164
...
void loop() 
{
  ...
  zr2.toCharArray(d0, 16);client.publish("IRH02/ZR2", d0);
  zr6.toCharArray(d1, 16);client.publish("IRH02/ZR6", d1);
  d5210.toCharArray(d2, 16);client.publish("IRH02/D5210", d2);
  d5230.toCharArray(d3, 16);client.publish("IRH02/D5230", d3);
  d5250.toCharArray(d4, 16);client.publish("IRH02/D5250", d4);
  zr532.toCharArray(d5, 16);client.publish("IRH02/ZR532", d5);
  zr552.toCharArray(d6, 16);client.publish("IRH02/ZR552", d6);
  zr572.toCharArray(d7, 16);client.publish("IRH02/ZR572", d7);
  zr632.toCharArray(d8, 16);client.publish("IRH02/ZR632", d8);
  zr652.toCharArray(d9, 16);client.publish("IRH02/ZR652", d9);
  zr672.toCharArray(d10, 16);client.publish("IRH02/ZR672", d10);
  zr732.toCharArray(d11, 16);client.publish("IRH02/ZR732", d11);
  zr752.toCharArray(d12, 16);client.publish("IRH02/ZR752", d12);
  zr772.toCharArray(d13, 16);client.publish("IRH02/ZR772", d13);
  rssi.toCharArray(d_rssi, 16);client.publish("IRH02/rssi", d_rssi);
