...
node.readHoldingRegisters(1, 1);   Serial.print("COLUMN1 A RING NO.1 : ");  Serial.println(node.getResponseBuffer(0));D11002= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(2, 1);   Serial.print("COLUMN1 A RING NO.2 : ");  Serial.println(node.getResponseBuffer(0));D11003= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(3, 1);   Serial.print("COLUMN1 A RING NO.3 : ");  Serial.println(node.getResponseBuffer(0));D11004= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(4, 1);   Serial.print("COLUMN1 A RING NO.4 : ");  Serial.println(node.getResponseBuffer(0));D11005= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(5, 1);   Serial.print("COLUMN1 A RING NO.5 : ");  Serial.println(node.getResponseBuffer(0));D11006= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(6, 1);   Serial.print("COLUMN1 A RING NO.6 : ");  Serial.println(node.getResponseBuffer(0));D11007= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(7, 1);   Serial.print("COLUMN1 A RING NO.7 : ");  Serial.println(node.getResponseBuffer(0));D11008= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(8, 1);   Serial.print("COLUMN1 A RING NO.8 : ");  Serial.println(node.getResponseBuffer(0));D11009= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(9, 1);   Serial.print("COLUMN1 A RING NO.9 : ");  Serial.println(node.getResponseBuffer(0));D11010= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(10, 1);   Serial.print("COLUMN1 A RING NO.10 : ");  Serial.println(node.getResponseBuffer(0));D11011= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(11, 1);   Serial.print("COLUMN1 A RING NO.11 : ");  Serial.println(node.getResponseBuffer(0));D11012= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(12, 1);   Serial.print("COLUMN1 A RING NO.12 : ");  Serial.println(node.getResponseBuffer(0));D11013= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(13, 1);   Serial.print("COLUMN1 A RING NO.13 : ");  Serial.println(node.getResponseBuffer(0));D11014= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(14, 1);   Serial.print("COLUMN1 A RING NO.14 : ");  Serial.println(node.getResponseBuffer(0));D11015= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(15, 1);   Serial.print("COLUMN1 A RING NO.15 : ");  Serial.println(node.getResponseBuffer(0));D11016= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(16, 1);   Serial.print("COLUMN1 A RING NO.16 : ");  Serial.println(node.getResponseBuffer(0));D11017= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(17, 1);   Serial.print("COLUMN1 A RING NO.17 : ");  Serial.println(node.getResponseBuffer(0));D11018= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(18, 1);   Serial.print("COLUMN1 A RING NO.18 : ");  Serial.println(node.getResponseBuffer(0));D11019= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(19, 1);   Serial.print("COLUMN1 A RING NO.19 : ");  Serial.println(node.getResponseBuffer(0));D11020= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(20, 1);   Serial.print("COLUMN1 A RING NO.20 : ");  Serial.println(node.getResponseBuffer(0));D11021= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(21, 1);   Serial.print("COLUMN1 A RING NO.21 : ");  Serial.println(node.getResponseBuffer(0));D11022= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(22, 1);   Serial.print("COLUMN1 A RING NO.22 : ");  Serial.println(node.getResponseBuffer(0));D11023= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(23, 1);   Serial.print("COLUMN1 A RING NO.23 : ");  Serial.println(node.getResponseBuffer(0));D11024= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(24, 1);   Serial.print("COLUMN1 A RING NO.24 : ");  Serial.println(node.getResponseBuffer(0));D11025= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(25, 1);   Serial.print("COLUMN1 A RING NO.25 : ");  Serial.println(node.getResponseBuffer(0));D11026= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(26, 1);   Serial.print("COLUMN1 A RING NO.26 : ");  Serial.println(node.getResponseBuffer(0));D11027= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(27, 1);   Serial.print("COLUMN1 A RING NO.27 : ");  Serial.println(node.getResponseBuffer(0));D11028= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(28, 1);   Serial.print("COLUMN1 A RING NO.28 : ");  Serial.println(node.getResponseBuffer(0));D11029= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(29, 1);   Serial.print("COLUMN1 A RING NO.29 : ");  Serial.println(node.getResponseBuffer(0));D11030= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(30, 1);   Serial.print("COLUMN1 A RING NO.30 : ");  Serial.println(node.getResponseBuffer(0));D11031= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(31, 1);   Serial.print("COLUMN1 A RING NO.31 : ");  Serial.println(node.getResponseBuffer(0));D11032= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(32, 1);   Serial.print("COLUMN1 A RING NO.32 : ");  Serial.println(node.getResponseBuffer(0));D11033= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(33, 1);   Serial.print("COLUMN1 A RING NO.33 : ");  Serial.println(node.getResponseBuffer(0));D11034= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(34, 1);   Serial.print("COLUMN1 A RING NO.34 : ");  Serial.println(node.getResponseBuffer(0));D11035= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(35, 1);   Serial.print("COLUMN1 A RING NO.35 : ");  Serial.println(node.getResponseBuffer(0));D11036= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(36, 1);   Serial.print("COLUMN1 A RING NO.36 : ");  Serial.println(node.getResponseBuffer(0));D11037= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(37, 1);   Serial.print("COLUMN1 A RING NO.37 : ");  Serial.println(node.getResponseBuffer(0));D11038= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(38, 1);   Serial.print("COLUMN1 A RING NO.38 : ");  Serial.println(node.getResponseBuffer(0));D11039= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(39, 1);   Serial.print("COLUMN1 A RING NO.39 : ");  Serial.println(node.getResponseBuffer(0));D11040= node.getResponseBuffer(0);  node.clearResponseBuffer();
...
node.readHoldingRegisters(80, 1);   Serial.print("COLUMN1 B RING NO.1 : ");  Serial.println(node.getResponseBuffer(0));D11081= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(81, 1);   Serial.print("COLUMN1 B RING NO.2 : ");  Serial.println(node.getResponseBuffer(0));D11082= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(82, 1);   Serial.print("COLUMN1 B RING NO.3 : ");  Serial.println(node.getResponseBuffer(0));D11083= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(83, 1);   Serial.print("COLUMN1 B RING NO.4 : ");  Serial.println(node.getResponseBuffer(0));D11084= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(84, 1);   Serial.print("COLUMN1 B RING NO.5 : ");  Serial.println(node.getResponseBuffer(0));D11085= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(85, 1);   Serial.print("COLUMN1 B RING NO.6 : ");  Serial.println(node.getResponseBuffer(0));D11086= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(86, 1);   Serial.print("COLUMN1 B RING NO.7 : ");  Serial.println(node.getResponseBuffer(0));D11087= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(87, 1);   Serial.print("COLUMN1 B RING NO.8 : ");  Serial.println(node.getResponseBuffer(0));D11088= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(88, 1);   Serial.print("COLUMN1 B RING NO.9 : ");  Serial.println(node.getResponseBuffer(0));D11089= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(89, 1);   Serial.print("COLUMN1 B RING NO.10 : ");  Serial.println(node.getResponseBuffer(0));D11090= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(90, 1);   Serial.print("COLUMN1 B RING NO.11 : ");  Serial.println(node.getResponseBuffer(0));D11091= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(91, 1);   Serial.print("COLUMN1 B RING NO.12 : ");  Serial.println(node.getResponseBuffer(0));D11092= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(92, 1);   Serial.print("COLUMN1 B RING NO.13 : ");  Serial.println(node.getResponseBuffer(0));D11093= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(93, 1);   Serial.print("COLUMN1 B RING NO.14 : ");  Serial.println(node.getResponseBuffer(0));D11094= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(94, 1);   Serial.print("COLUMN1 B RING NO.15 : ");  Serial.println(node.getResponseBuffer(0));D11095= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(95, 1);   Serial.print("COLUMN1 B RING NO.16 : ");  Serial.println(node.getResponseBuffer(0));D11096= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(96, 1);   Serial.print("COLUMN1 B RING NO.17 : ");  Serial.println(node.getResponseBuffer(0));D11097= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(97, 1);   Serial.print("COLUMN1 B RING NO.18 : ");  Serial.println(node.getResponseBuffer(0));D11098= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(98, 1);   Serial.print("COLUMN1 B RING NO.19 : ");  Serial.println(node.getResponseBuffer(0));D11099= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(99, 1);   Serial.print("COLUMN1 B RING NO.20 : ");  Serial.println(node.getResponseBuffer(0));D11100= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(100, 1);   Serial.print("COLUMN1 B RING NO.21 : ");  Serial.println(node.getResponseBuffer(0));D11101= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(101, 1);   Serial.print("COLUMN1 B RING NO.22 : ");  Serial.println(node.getResponseBuffer(0));D11102= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(102, 1);   Serial.print("COLUMN1 B RING NO.23 : ");  Serial.println(node.getResponseBuffer(0));D11103= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(103, 1);   Serial.print("COLUMN1 B RING NO.24 : ");  Serial.println(node.getResponseBuffer(0));D11104= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(104, 1);   Serial.print("COLUMN1 B RING NO.25 : ");  Serial.println(node.getResponseBuffer(0));D11105= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(105, 1);   Serial.print("COLUMN1 B RING NO.26 : ");  Serial.println(node.getResponseBuffer(0));D11106= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(106, 1);   Serial.print("COLUMN1 B RING NO.27 : ");  Serial.println(node.getResponseBuffer(0));D11107= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(107, 1);   Serial.print("COLUMN1 B RING NO.28 : ");  Serial.println(node.getResponseBuffer(0));D11108= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(108, 1);   Serial.print("COLUMN1 B RING NO.29 : ");  Serial.println(node.getResponseBuffer(0));D11109= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(109, 1);   Serial.print("COLUMN1 B RING NO.30 : ");  Serial.println(node.getResponseBuffer(0));D11110= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(110, 1);   Serial.print("COLUMN1 B RING NO.31 : ");  Serial.println(node.getResponseBuffer(0));D11111= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(111, 1);   Serial.print("COLUMN1 B RING NO.32 : ");  Serial.println(node.getResponseBuffer(0));D11112= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(112, 1);   Serial.print("COLUMN1 B RING NO.33 : ");  Serial.println(node.getResponseBuffer(0));D11113= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(113, 1);   Serial.print("COLUMN1 B RING NO.34 : ");  Serial.println(node.getResponseBuffer(0));D11114= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(114, 1);   Serial.print("COLUMN1 B RING NO.35 : ");  Serial.println(node.getResponseBuffer(0));D11115= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(115, 1);   Serial.print("COLUMN1 B RING NO.36 : ");  Serial.println(node.getResponseBuffer(0));D11116= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(116, 1);   Serial.print("COLUMN1 B RING NO.37 : ");  Serial.println(node.getResponseBuffer(0));D11117= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(117, 1);   Serial.print("COLUMN1 B RING NO.38 : ");  Serial.println(node.getResponseBuffer(0));D11118= node.getResponseBuffer(0);  node.clearResponseBuffer();
node.readHoldingRegisters(118, 1);   Serial.print("COLUMN1 B RING NO.39 : ");  Serial.println(node.getResponseBuffer(0));D11119= node.getResponseBuffer(0);  node.clearResponseBuffer();
