...
void loop() 
{
  ...
  rssi.toCharArray(d_rssi, 16);client.publish("ORH04/rssi", d_rssi);
  zr2.toCharArray(d0, 16);client.publish("ORH04/ZR2", d0);
  zr6.toCharArray(d1, 16);client.publish("ORH04/ZR6", d1);
  zr532.toCharArray(d2, 16);client.publish("ORH04/ZR532", d2);
  zr552.toCharArray(d3, 16);client.publish("ORH04/ZR552", d3);
  zr572.toCharArray(d4, 16);client.publish("ORH04/ZR572", d4);
  zr632.toCharArray(d5, 16);client.publish("ORH04/ZR632", d5);
  zr652.toCharArray(d6, 16);client.publish("ORH04/ZR652", d6);
  zr672.toCharArray(d7, 16);client.publish("ORH04/ZR672", d7);
  zr732.toCharArray(d8, 16);client.publish("ORH04/ZR732", d8);
  zr752.toCharArray(d9, 16);client.publish("ORH04/ZR752", d9);
  zr772.toCharArray(d10, 16);client.publish("ORH04/ZR772", d10);
