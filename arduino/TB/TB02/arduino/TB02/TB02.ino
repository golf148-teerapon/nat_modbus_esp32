...
IPAddress local_IP(192, 168, 1, 32); // Static IP address192.168.100.164
...
void loop() 
{
  ...
  m108.toCharArray(i0, 16);client.publish("TB02/M108", i0);
  m94.toCharArray(i1, 16);client.publish("TB02/M94", i1);
  m76.toCharArray(i2, 16);client.publish("TB02/M76", i2);
  m62.toCharArray(i3, 16);client.publish("TB02/M62", i3);
  m60.toCharArray(i4, 16);client.publish("TB02/M60", i4);
  m28.toCharArray(i5, 16);client.publish("TB02/M28", i5);
  m26.toCharArray(i6, 16);client.publish("TB02/M26", i6);
  m19.toCharArray(i7, 16);client.publish("TB02/M19", i7);
  m6.toCharArray(i8, 16);client.publish("TB02/M6", i8);
  m63.toCharArray(i9, 16);client.publish("TB02/M63", i9);
  d330.toCharArray(i10, 16);client.publish("TB02/D330", i10);
  d332.toCharArray(i11, 16);client.publish("TB02/D332", i11);
  d334.toCharArray(i12, 16);client.publish("TB02/D334", i12);
  d336.toCharArray(i13, 16);client.publish("TB02/D336", i13);
  d338.toCharArray(i14, 16);client.publish("TB02/D338", i14);
  d340.toCharArray(i15, 16);client.publish("TB02/D340", i15);
  d342.toCharArray(i16, 16);client.publish("TB02/D342", i16);
  d352.toCharArray(i17, 16);client.publish("TB02/D352", i17);
  d344.toCharArray(i18, 16);client.publish("TB02/D344", i18);
  d346.toCharArray(i19, 16);client.publish("TB02/D346", i19);
  d348.toCharArray(i20, 16);client.publish("TB02/D348", i20);
  d350.toCharArray(i21, 16);client.publish("TB02/D350", i21);
  d32.toCharArray(i22, 16);client.publish("TB02/D32", i22);
  d226.toCharArray(i23, 16);client.publish("TB02/D226", i23);
  d354.toCharArray(i24, 16);client.publish("TB02/D354", i24);
  d286.toCharArray(i25, 16);client.publish("TB02/D286", i25);
  d242.toCharArray(i26, 16);client.publish("TB02/D242", i26);
  d241.toCharArray(i27, 16);client.publish("TB02/D241", i27);
  d240.toCharArray(i28, 16);client.publish("TB02/D240", i28);
  d245.toCharArray(i29, 16);client.publish("TB02/D245", i29);
  d244.toCharArray(i30, 16);client.publish("TB02/D244", i30);
  d243.toCharArray(i31, 16);client.publish("TB02/D243", i31);
  d100.toCharArray(i32, 16);client.publish("TB02/D100", i32);
  d102.toCharArray(i33, 16);client.publish("TB02/D102", i33);
  d104.toCharArray(i34, 16);client.publish("TB02/D104", i34);
  d106.toCharArray(i35, 16);client.publish("TB02/D106", i35);
  d108.toCharArray(i36, 16);client.publish("TB02/D108", i36);
  d110.toCharArray(i37, 16);client.publish("TB02/D110", i37);
  d112.toCharArray(i38, 16);client.publish("TB02/D112", i38);
  d114.toCharArray(i39, 16);client.publish("TB02/D114", i39);
  d116.toCharArray(i40, 16);client.publish("TB02/D116", i40);
  d118.toCharArray(i41, 16);client.publish("TB02/D118", i41);
  d120.toCharArray(i42, 16);client.publish("TB02/D120", i42);
  d122.toCharArray(i43, 16);client.publish("TB02/D122", i43);
  d124.toCharArray(i44, 16);client.publish("TB02/D124", i44);
  d126.toCharArray(i45, 16);client.publish("TB02/D126", i45);
  d128.toCharArray(i46, 16);client.publish("TB02/D128", i46);
  m34.toCharArray(i47, 16);client.publish("TB02/M34", i47);
  m36.toCharArray(i48, 16);client.publish("TB02/M36", i48);
