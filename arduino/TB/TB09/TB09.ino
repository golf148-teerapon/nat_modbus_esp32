...
IPAddress local_IP(192, 168, 1, 39); // ******Change ip *********
...
void loop() 
{
  ...
  M34.toCharArray(i0, 16);client.publish("TB09/M34", i0);
  M36.toCharArray(i1, 16);client.publish("TB09/M36", i1);
  D330.toCharArray(i2, 16);client.publish("TB09/D330", i2);
  D332.toCharArray(i3, 16);client.publish("TB09/D332", i3);
  D334.toCharArray(i4, 16);client.publish("TB09/D334", i4);
  D336.toCharArray(i5, 16);client.publish("TB09/D336", i5);
  D338.toCharArray(i6, 16);client.publish("TB09/D338", i6);
  D340.toCharArray(i7, 16);client.publish("TB09/D340", i7);
  D342.toCharArray(i8, 16);client.publish("TB09/D342", i8);     
  D344.toCharArray(i9, 16);client.publish("TB09/D344", i9);
  D346.toCharArray(i10, 16);client.publish("TB09/D346", i10);
  D348.toCharArray(i11, 16);client.publish("TB09/D348", i11);
  D350.toCharArray(i12, 16);client.publish("TB09/D350", i12);
  D226.toCharArray(i13, 16);client.publish("TB09/D226", i13);
  D100.toCharArray(i14, 16);client.publish("TB09/D100", i14);
  D102.toCharArray(i15, 16);client.publish("TB09/D102", i15);
  D104.toCharArray(i16, 16);client.publish("TB09/D104", i16);
  D106.toCharArray(i17, 16);client.publish("TB09/D106", i17);
  D108.toCharArray(i18, 16);client.publish("TB09/D108", i18);
  D110.toCharArray(i19, 16);client.publish("TB09/D110", i19);  
  D112.toCharArray(i20, 16);client.publish("TB09/D112", i20); 
  D114.toCharArray(i21, 16);client.publish("TB09/D114", i21);
  D362.toCharArray(i22, 16);client.publish("TB09/D362", i22);
  D364.toCharArray(i23, 16);client.publish("TB09/D364", i23);
  D368.toCharArray(i24, 16);client.publish("TB09/D368", i24);
  D370.toCharArray(i25, 16);client.publish("TB09/D370", i25);
  D356.toCharArray(i26, 16);client.publish("TB09/D356", i26);
  D372.toCharArray(i27, 16);client.publish("TB09/D372", i27);
  D354.toCharArray(i28, 16);client.publish("TB09/D354", i28);
  D366.toCharArray(i29, 16);client.publish("TB09/D366", i29);
  D116.toCharArray(i30, 16);client.publish("TB09/D116", i30);
  D122.toCharArray(i31, 16);client.publish("TB09/D122", i31);
  D126.toCharArray(i32, 16);client.publish("TB09/D126", i32);
  D128.toCharArray(i33, 16);client.publish("TB09/D128", i33);
  D118.toCharArray(i34, 16);client.publish("TB09/D118", i34);
  D120.toCharArray(i35, 16);client.publish("TB09/D120", i35);
  D124.toCharArray(i36, 16);client.publish("TB09/D124", i36);
  D286.toCharArray(i37, 16);client.publish("TB09/D286", i37);
  D32.toCharArray(i38, 16);client.publish("TB09/D32", i38);
