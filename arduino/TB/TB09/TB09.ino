...
void loop() 
{
  ...
  D330.toCharArray(i1, 16);client.publish("TB09/D330", i1);
  D332.toCharArray(i2, 16);client.publish("TB09/D332", i2);
  D334.toCharArray(i3, 16);client.publish("TB09/D334", i3);
  D336.toCharArray(i4, 16);client.publish("TB09/D336", i4);
  D338.toCharArray(i5, 16);client.publish("TB09/D338", i5);
  D340.toCharArray(i6, 16);client.publish("TB09/D340", i6);
  D342.toCharArray(i7, 16);client.publish("TB09/D342", i7);     
  D344.toCharArray(i8, 16);client.publish("TB09/D344", i8);
  D346.toCharArray(i9, 16);client.publish("TB09/D346", i9);
  D348.toCharArray(i10, 16);client.publish("TB09/D348", i10);
  D350.toCharArray(i11, 16);client.publish("TB09/D350", i11);
  D226.toCharArray(i12, 16);client.publish("TB09/D226", i12);
  D100.toCharArray(i13, 16);client.publish("TB09/D100", i13);
  D102.toCharArray(i14, 16);client.publish("TB09/D102", i14);
  D104.toCharArray(i15, 16);client.publish("TB09/D104", i15);
  D106.toCharArray(i16, 16);client.publish("TB09/D106", i16);
  D108.toCharArray(i17, 16);client.publish("TB09/D108", i17);
  D110.toCharArray(i18, 16);client.publish("TB09/D110", i18);  
  D112.toCharArray(i19, 16);client.publish("TB09/D112", i19); 
  D114.toCharArray(i20, 16);client.publish("TB09/D114", i20);
  M36.toCharArray(i21, 16);client.publish("TB09/M36", i21);
