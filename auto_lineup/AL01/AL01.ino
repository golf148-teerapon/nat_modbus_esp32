...
IPAddress local_IP(192, 168, 1, 61); // Static IP address192.168.100.164
...
char d_rssi[16],d0[16],d1[16],d2[16];
...
void loop() 
{
  ...
  delay(500);
  led_blue();
  rssi.toCharArray(d_rssi, 16);client.publish("AL01/rssi", d_rssi);
  d306.toCharArray(d0, 16);client.publish("AL01/D306", d0);
  d308.toCharArray(d1, 16);client.publish("AL01/D308", d1);
  d304.toCharArray(d2, 16);client.publish("AL01/D304", d2);
