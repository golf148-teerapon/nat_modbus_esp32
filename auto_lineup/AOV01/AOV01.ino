...
void setup() 
{
  ...
  ArduinoOTA.setHostname("AL01"); //ota name
...
String rssi,d250,d254,d258,d262,d100;
char d_rssi[16],d0[16],d1[16],d2[16],d3[16],d4[16];
...
void loop() 
{
  ...
  delay(500);
  led_blue();
  rssi.toCharArray(d_rssi, 16);client.publish("AOV01/rssi", d_rssi);
  d250.toCharArray(d0, 16);client.publish("AOV01/D250", d0);
  d254.toCharArray(d1, 16);client.publish("AOV01/D254", d1);
  d258.toCharArray(d2, 16);client.publish("AOV01/D258", d2);
  d262.toCharArray(d3, 16);client.publish("AOV01/D262", d3);
  d100.toCharArray(d4, 16);client.publish("AOV01/D100", d4);
  Serial.println("\n---------------finish loop------------------\n\n");
  delay(5000);
}
