...
String rssi,d3162,d3102,d3166,d3106,d3168,d3108,d3170,d3110,d52;
char d_rssi[16],d0[16],d1[16],d2[16],d3[16],d4[16],d5[16],d6[16],d7[16],d8[16];
...
void loop() 
{
  ...
  d52.toCharArray(d8, 16);client.publish("AN01/D52", d8);
